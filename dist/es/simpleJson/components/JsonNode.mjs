...
import { resolveComponent, openBlock, createElementBlock, normalizeClass, normalizeStyle, createVNode, createCommentVNode, createElementVNode, createBlock, withCtx, toDisplayString, renderSlot, Fragment, withDirectives, renderList, vModelSelect } from 'vue';
    ...
    createElementVNode("span", _hoisted_2, [
      ...
      _ctx.isSub && !_ctx.valueSlot ? (openBlock(), createElementBlock(Fragment, { key: 6 }, [
        ...
        createElementVNode("span", {
          class: normalizeClass({ "root-brackets": _ctx.stateData.root && _ctx.isExtend })
        }, toDisplayString(_ctx.json.type === "object" ? "}" : "]"), 3)
