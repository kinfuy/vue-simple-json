...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return !_ctx.isRefresh ? (openBlock(), createElementBlock("div", {
    ...
    createElementVNode("span", {
      ...
      ], 64)) : _ctx.type === "string" ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
        createTextVNode(toDisplayString(`"${_ctx.stateValue}"`), 1)
      ], 64)) : createCommentVNode("v-if", true)
    ], 34)
  ])) : createCommentVNode("v-if", true);
}
var ValueEditor = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:\\project\\\u4E2A\u4EBA\\simple-json\\package\\simpleJson\\components\\ValueEditor.vue"]]);
