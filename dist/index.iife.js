var UxdIconsVue = (function (exports, vue, clonedeep) {
  'use strict';
  ...
  function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
    return !_ctx.isRefresh ? (vue.openBlock(), vue.createElementBlock("div", {
      ...
      vue.createElementVNode("span", {
        ...
        ], 2112)) : _ctx.type === "string" ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 1 }, [
          vue.createTextVNode(vue.toDisplayString(`"${_ctx.stateValue}"`), 1)
  ...
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("svg", {
      class: vue.normalizeClass(["svg-icon", _ctx.fixClass]),
      "aria-hidden": "true"
    }, [
      vue.createElementVNode("use", { "xlink:href": _ctx.iconName }, null, 8, _hoisted_1$1)
    ], 2);
  }
  ...
  const _sfc_main$2 = vue.defineComponent({
    ...
    setup(props) {
      ...
      const { extendLevel, extendAll, extendCatchKey, disabled, jsonConfig } = vue.inject("JsonEditorContext");
      ...
      const handleValueChange = (value, item, type = "value") => {
        item[type] = value;
        if (eventTrigger)
          eventTrigger("change", clonedeep__default["default"](stateData.value));
      };
      ...
      const handleAttrDelete = () => {
        var _a;
        if (eventTrigger)
          eventTrigger("delete", clonedeep__default["default"](stateData.value));
      ...
      const handleCustom = (operate) => {
        if (stateData.value) {
          const currect = {
            ...
            value: isSub.value ? deepReductionJson(stateData.value.value) : clonedeep__default["default"](stateData.value.value)
          };
    ...
    return _ctx.stateData ? (vue.openBlock(), vue.createElementBlock("div", {
      ...
      vue.createElementVNode("span", _hoisted_2, [
        ...
        _ctx.isSub && !_ctx.valueSlot ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 6 }, [
          ...
          vue.createElementVNode("span", null, vue.toDisplayString(_ctx.json.type === "object" ? "}" : "]"), 1)
